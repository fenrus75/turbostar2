...
public:
    ...
    bool validate_runtime(const tool_context& /*ctx*/, std::string& /*out_error*/) const override { return true; }
    std::string execute(tool_context& /*ctx*/) override { return str_; }
private:
    std::string str_;
};
...
public:
    ...
    std::string get_description() const override { return "mock desc"; }
    std::string get_parameter_name() const override { return "param"; }
    std::string get_parameter_description() const override { return "param desc"; }

...
{
      public:
	find_dialog(const std::string &title,
		    const search_params &initial_params,
	...
	search_params get_search_params() const;
      ...
      private:
	void draw_group_box(int y, int x, int w, int h,
			    const std::string &title) const;
	void draw_labeled_text(int y, int x, const std::string &text,
			       char hotkey) const;
	void draw_group_labeled_text(int ly, int lx, const std::string &text,
				     char hotkey) const;

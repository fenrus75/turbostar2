...
public:
    ...
    // Retrieves and clears the most recent coredump report generated by this runner.
    std::string get_new_coredumps() {
        std::string res = last_coredumps_report_;
        last_coredumps_report_.clear();
        return res;
    }

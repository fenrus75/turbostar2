...
{
	agentlib::tool_registry::get_instance().register_validator([]() { return std::make_unique<tools::image_export_validator>(); });
}

void unregister_image_export(void)
{
	agentlib::tool_registry::get_instance().unregister_validator("image_export");
}
}

...
std::vector<outgoing_call_reference>
get_outgoing_calls_in_range(const std::string &safe_path, int start_line, int end_line, agentlib::tool_context *ctx = nullptr,
			    std::chrono::steady_clock::time_point deadline = std::chrono::steady_clock::time_point::max());

std::vector<outgoing_call_reference>
get_outgoing_calls_in_range(const std::string &safe_path, int start_line, int end_line, const std::vector<codemap_symbol_info> &doc_symbols,
...
// Always 4 columns (| Symbol | start_line | end_line | lines |)
std::string format_codemap_table(const std::string &display_path, const std::vector<codemap_symbol_info> &symbols,
				 size_t total_file_lines = 0, size_t total_symbols_count = 0, size_t omitted_count = 0,
				 agentlib::tool_context *ctx = nullptr, bool full = true, size_t pruned_count = 0,

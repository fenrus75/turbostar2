...
int main(int argc, char** argv) {
    ...
    prompt = (argc > 1) ? argv[1] : "Please read lines 1 to 5 of src/agentcli/main.cpp using fs_read_lines.";
    ...
    system_msg.content = "You are a helpful assistant. You must use the provided fs_read_lines tool if the user asks to read a file.";

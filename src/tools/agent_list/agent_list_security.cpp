...
public:
    ...
    std::string get_name() const override { return "list_agents"; }
    std::string get_description() const override { return "Lists all active subagents managed by the current agent, returning a markdown table of ID, name, and status."; }

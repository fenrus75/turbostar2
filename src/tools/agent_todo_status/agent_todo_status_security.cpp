...
public:
    ...
    std::string get_name() const override { return "agent_todo_status"; }
    std::string get_description() const override { return "Returns the todo list with completion status of a specific subagent by its ID."; }

...
nlohmann::json image_export_validator::get_parameters_schema() const
{
	return {
	    {"type", "object"},
	    {"properties",
	     {{"name", {{"type", "string"}, {"description", "The name alias or VFS URI of the image to export."}}},
	      {"filename", {{"type", "string"}, {"description", "The destination path relative to the project root where the file will be saved."}}}}},

...
class sqlite_delete_db_validator : public agentlib::single_string_tool_validator
{
	...
	{
		return "sqlite_delete_db";
	}
	std::string get_description() const override
	{
		return "Deletes an existing SQLite database for the project.";
	}
	...
	{
		return "The simple name of the database to delete (no paths or extensions).";
	}

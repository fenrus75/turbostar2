...
public:
    bool is_pure() const override { return false; } // Modifies agent state

    std::string get_name() const override { return "create_agent"; }
    std::string get_description() const override { return "Creates a new subagent to delegate tasks to. The profile defines the agent's initial prompt and instructions."; }
    ...
    nlohmann::json get_parameters_schema() const override {
        return {
            ...
            {"properties", {
                ...
                {"profile", {{"type", "string"}, {"description", "The initial prompt and system instructions for the subagent to execute."}}}
            }},

...
public:
    std::string get_name() const override { return "agent_complete_todo"; }
    std::string get_description() const override { return "Marks a task as complete in the AI agent's internal todo list. Provide an exact string match or a unique substring."; }

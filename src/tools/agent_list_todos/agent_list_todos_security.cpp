...
public:
    ...
    std::string get_name() const override { return "agent_list_todos"; }
    std::string get_description() const override { return "Lists all tasks currently in the AI agent's internal todo list, formatted as markdown checkboxes."; }

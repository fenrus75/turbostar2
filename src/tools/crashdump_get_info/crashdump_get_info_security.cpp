...
public:
    ...
    std::string get_name() const override { return "crashdump_get_info"; }
    std::string get_description() const override { return "Retrieves the detailed backtrace and memory map of a specific crashdump by its ID."; }
    
    nlohmann::json get_parameters_schema() const override {
        return {
            {"type", "object"},
            {"properties", {
                {"crash_id", {{"type", "string"}, {"description", "The Crash ID of the crashed executable."}}}
            }},

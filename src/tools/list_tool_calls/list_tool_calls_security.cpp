...
public:
    std::string get_name() const override { return "list_tool_calls"; }
    std::string get_description() const override { return "Lists all available LLM tools and their descriptions as a Markdown table. Use this to introspect your capabilities."; }

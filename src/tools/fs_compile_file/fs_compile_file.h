...
public:
    ...
    std::string get_description() const override { return "Compiles a single file (synchronously) and returns the raw console output. Populates the workspace error list."; }

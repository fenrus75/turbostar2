...
public:
    fs_compile_project_tool() = default;
...
public:
    ...
    std::string get_description() const override { return "Compiles the entire project (synchronously) and returns the raw console output. Populates the workspace error list."; }

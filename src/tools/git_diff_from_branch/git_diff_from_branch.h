...
class git_diff_from_branch_tool : public agentlib::llm_tool_action {
public:
    explicit git_diff_from_branch_tool(std::string branch_name);
...
class git_diff_from_branch_validator : public agentlib::single_string_tool_validator {
public:

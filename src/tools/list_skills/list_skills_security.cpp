...
class list_skills_validator : public agentlib::tool_validator
{
	...
	{
		return "Lists all available specialized agent skills. Returns a Markdown table containing the skill name, URI, and "
		       "description. Use this to discover available skills.";
	}

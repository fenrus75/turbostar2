...
public:
    ...
    std::string get_description() const override { return "View the staged git diff for a specific file or directory (use '.' for the entire project). Returns raw patch output."; }

...
public:
    ...
    std::string get_name() const override { return "end_agent"; }
    std::string get_description() const override { return "Closes and terminates a specific subagent by its ID."; }
    
    nlohmann::json get_parameters_schema() const override {
        return {
            {"type", "object"},
            {"properties", {
                {"id", {{"type", "integer"}, {"description", "The ID of the subagent to terminate."}}}
            }},

...
public:
    std::string get_name() const override { return "ask_user"; }
    std::string get_description() const override { return "Ask the user a question to gather preferences or make decisions. A custom input 'Other' field is automatically provided."; }

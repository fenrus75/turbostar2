...
#include <string_view>
	...
	agentlib::start_app_result start_app(std::string_view args, bool use_debugger, bool auto_continue = true, bool collect_performance = false, std::string_view binary = "") override;
	...
	enum class input_mode { normal, k_block, q_block, p_block, searching, search_options, going_to_line, inline_agent, vim, replace_prompt, replace_query };
	...
	std::string replace_input_buffer_;

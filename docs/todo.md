...
## 03-08-2026
- `system/languages/cpp23_short.md` & Automated System Docs Embedding (`system/languages/cpp23.md`, `system/languages/cpp23_short.md`, `scripts/embed_system_docs.py`, `src/vfs/system_vfs_provider.cpp`, `src/ui/agent_window.cpp`, `meson.build`, `docs/todo.md`):
  ...
  5. Updated `agent_window.cpp` to auto-inject `system://languages/cpp23_short.md` into the active system prompt.
  6. Verified 100% test suite pass rate (248 OK, 1 Expected Fail, 2 Skipped).

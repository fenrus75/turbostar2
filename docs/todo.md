...
- GEMINI.md Coding Guidelines Synchronization: Updated `GEMINI.md` with C++23 rules from `templates/meson_cpp/AGENTS.md` (RAII, `std::string_view`, Standard Library algorithms, security validation, and rationale comments).

...
## 01-08-2026
- `system://project/` VFS Directory & Removal of `fs_list_tests` (`src/vfs/system_vfs_provider.cpp`, `src/tools/meson.build`, `meson.build`, `src/ui/agent_window.cpp`, `tests/unit/test_system_vfs.cpp`, `docs/tools.md`):
  1. Created `system://project/` virtual directory containing:
     - `system://project/diagnostics.md` (replaces `fs_compile_summary`).
     - `system://project/info.md` (overview of workspace root, build system type, and `GEMINI.md`/`AGENTS.md` presence).

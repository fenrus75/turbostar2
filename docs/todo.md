...
## 03-08-2026
- `system/languages/cpp23_short.md` & Conditional Language Guideline Injection (`system/languages/cpp23.md`, `system/languages/cpp23_short.md`, `scripts/embed_system_docs.py`, `src/vfs/system_vfs_provider.cpp`, `src/ui/agent_window.cpp`, `meson.build`, `docs/todo.md`):

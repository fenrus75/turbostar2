...
## 24-05-2026
- implemented a `/model` slash command in the agent window and a corresponding "Select Model..." menu item in the Agent menu. These allow users to dynamically switch the AI model for the current agent session. A system message is added to the chat history to record the switch.

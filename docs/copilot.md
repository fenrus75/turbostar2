...
- [x] **Step 6**: Added query of GitHub models catalog (`https://api.githubcopilot.com/models`) at signup to write a formatted `models.json.github` into `~/.cache/turbostar/`.

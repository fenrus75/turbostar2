...
- **Virtual Filesystem (`system://` VFS)**: Provides an in-process URI scheme (`system://`) for demand-loaded system prompts, language coding standards (`system://languages/cpp23.md`, `system://languages/python311.md`, `system://languages/c17.md`, `system://languages/rust2021.md`, `system://languages/typescript.md`, `system://languages/verilog.md`), workflow guidelines (`system://workflows/code_review.md`, `system://workflows/plan_mode.md`), and dynamic runtime index generators (`system://agents.md`, `system://tools.md`, `system://mcp.md`). Static markdown files in `system/` are compiled into header constants (`src/system_docs_embedded.h`) via `scripts/embed_system_docs.py`. Supports root fallback aliases (e.g., `system://cpp23.md`), project/user overrides (`.turbostar/docs/`), and Turn 1 auto-injection based on the project's configured `primary_language` setting.
